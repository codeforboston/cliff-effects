...
/** Default client values. ALL THESE MUST ALWAYS BE VALID.
 * 
 * Note: A 'positive number' money value can have more than
 *     two decimal places.
 */
const CLIENT_DEFAULTS = {
  // @todo jsdoc comments for each prop.
  current: {
    // Current programs
    ...
    // Household
    // 'm_' for 'member'
    household:   [           // one or more member objects
      {
    ...
    // @todo Make housing expense values more robust for calculations.
  ...
  future: {}, // starts out same as `current`
