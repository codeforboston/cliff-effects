export default {
  ...
  aboutPage: {
    ...
    whatForImportantNote1B: 'Diese Anwendung ist ein Minimum Viable Product ' + 
    ...
    howToUseRefreshNote1A: 'Bitte bemerken Sie, daß diese Anwendung die Benutzerdaten nicht ' + 
      'behaltet. ',
    hotToUseRefreshNote1B: 'Wenn Sie die Webseite wieder aufnehmen, wird Ihre Daten ' + 
      'verloren werden. ',
    howToUseRefreshNote1C: 'Jedes Mal, wenn Sie die Anwendung verwenden, gibt die ' + 
      'Anwendung Ihnen ein neues, leeres Formular.',
    ...
    whoMadeThis3Intro: 'Wir möchten den folgenden Freiwilligen von Code for Boston ' + 
      'besonders danken: ',
    whoMadeThis3Names: 'Annie LaCourt, Isaac Chansky, Michelle Bernstein, Alec Danaher, ' + 
