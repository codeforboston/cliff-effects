...
const AboutContent = function ( props ) {
  ...
  return (
    <wrapper>
      ...
      <ul>
        <li><a target="_blank" href="https://www.youtube.com/watch?v=BveX_rID4_E">Two-minute video describing cliff effects</a></li>
        <li><a target="blank" href="http://www.nccp.org/projects/files/NCCP_CO_presentation07.pdf">Quantitative scenarios demonstrating cliff effects</a></li>
        <li><a target="blank" href="https://www.umb.edu/editor_uploads/images/centers_institutes/center_social_policy/The_Road_to_the_Cliff_Edge_08.16.17.pdf">Breakdown of different benefits offered in MA</a></li>
      </ul>
