...
const Table = function({ client, feedbackPrompt }) {
  return (
    <div>
      <Header as="h1" className="ui Header teal align centered">
        Results
      </Header>
      <Header as="h3" className="ui Header align centered">
      ...
      <Message visible warning style={{ textAlign: "center" }}>
        This tool is in testing and these numbers might not be right. If they're
        not, we'd appreciate your feedback.<br />
        <Button
          fluid
          color="teal"
          style={{
...
const Chart = function({ client }) {
  ...
  var {
    ...
    } = getBenefitTimeFrames(client, "hasHousing", getHousingBenefit),
