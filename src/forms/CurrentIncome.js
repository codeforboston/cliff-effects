...
const IncomeForm = function({ current, time, setClientProperty }) {
  ...
  return (
    <div className="field-aligner two-column">
      ...
      <CashFlowRow {...sharedProps} generic="TAFDC">
        {" "}
        TAFDC{" "}
      </CashFlowRow>
      <CashFlowRow {...sharedProps} generic="SSI">
        {" "}
        SSI{" "}
      </CashFlowRow>
      <CashFlowRow {...sharedProps} generic="SSDI">
        {" "}
        SSDI{" "}
      </CashFlowRow>
      <CashFlowRow {...sharedProps} generic="childSupportIn">
        {" "}
        Child support received{" "}
      </CashFlowRow>
      <CashFlowRow {...sharedProps} generic="unemployment">
        {" "}
        Unemployment{" "}
      </CashFlowRow>
      <CashFlowRow {...sharedProps} generic="workersComp">
        {" "}
        Worker’s comp{" "}
      </CashFlowRow>
      <CashFlowRow {...sharedProps} generic="pension">
        {" "}
        Pension{" "}
      </CashFlowRow>
      <CashFlowRow {...sharedProps} generic="socialSecurity">
        {" "}
        Social security{" "}
      </CashFlowRow>
      <CashFlowRow {...sharedProps} generic="alimony">
        {" "}
        Alimony{" "}
      </CashFlowRow>
      <CashFlowRow {...sharedProps} generic="otherIncome">
        {" "}
        Other income{" "}
      </CashFlowRow>
      <Form.Field>
