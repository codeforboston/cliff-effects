...
import { ContractRentField, RentShareField, PlainRentRow } from "./rentFields";
  ...
  if (current.shelter === "voucher") {
    ...
    return (
      <div>
        ...
        <CashFlowRow {...sharedProps} generic={"mortgage"}>
          {" "}
          Mortgage{" "}
        </CashFlowRow>
        <CashFlowRow {...sharedProps} generic={"housingInsurance"}>
          {" "}
          Insurance Costs{" "}
        </CashFlowRow>
        <CashFlowRow {...sharedProps} generic={"propertyTax"}>
          {" "}
          Property Tax{" "}
        </CashFlowRow>
        <Utilities {...sharedProps} />
...
const ExpensesFormContent = function({ current, time, setClientProperty }) {
  ...
  var elderlyOrDisabled = getEveryMember(household, isElderlyOrDisabled),
    elderlyOrDisabledHeadOrSpouse = getEveryMember(
      elderlyOrDisabled,
      isHeadOrSpouse
    );
    ...
    <div className="field-aligner two-column">
      {under13.length > 0 ? (
        <div>
          <FormHeading
            subheading={
              'A "child" is a person 12 or younger. Don\'t include amounts that are paid for by other benefit programs.\n'
            }
          >
            Reasonable Unreimbursed Non-Medical Child(ren) Care
          </FormHeading>
          <IntervalColumnHeadings type={type} />
          <CashFlowRow {...sharedProps} generic={"childDirectCare"}>
            {" "}
            Direct care costs{" "}
          </CashFlowRow>
          <CashFlowRow
          ...
          <CashFlowRow {...sharedProps} generic={"childTransportation"}>
            {" "}
            Transportation costs{" "}
          </CashFlowRow>
          <CashFlowRow {...sharedProps} generic={"childOtherCare"}>
            {" "}
            Other care{" "}
          </CashFlowRow>
          ...
          >
            <span style={{ textDecoration: "underline" }}>Income</span> made
            possible by child care expenses
          </CashFlowRowAfterConfirm>
        </div>
      ) : null}
      ...
      {current.hasSnap ? (
        <div>
          ...
          <IntervalColumnHeadings type={type} />
          <CashFlowRow {...sharedProps} generic={"childSupportPaidOut"}>
            {" "}
      ...
      {over12.length > 0 ? (
        <div>
          <FormHeading
            subheading={
              "For the care of people who are older than 12, but are still dependents (those under 18 or disabled). Don't include amounts that are paid for by other benefit programs.\n"
            }
          >
            Dependent Care of Persons Over 12 Years of Age
          </FormHeading>
          <IntervalColumnHeadings type={type} />
          <CashFlowRow {...sharedProps} generic={"adultDirectCare"}>
            {" "}
            Direct care costs{" "}
          </CashFlowRow>
          <CashFlowRow {...sharedProps} generic={"adultTransportation"}>
            {" "}
            Transportation costs{" "}
          </CashFlowRow>
          <CashFlowRow {...sharedProps} generic={"adultOtherCare"}>
            {" "}
            Other care{" "}
          </CashFlowRow>
        </div>
      ...
      {elderlyOrDisabled.length > 0 ? (
        <div>
          ...
          <div>
            Unreimbursed expenses to cover care attendants and auxiliary
            apparatus for any family member who is elderly or is a person with
            disabilities. Auxiliary apparatus are items such as wheelchairs,
            ramps, adaptations to vehicles, or special equipment to enable a
            blind person to read or type, but only if these items are directly
            related to permitting the disabled person or other family member to
            work.
          </div>
          <div>Examples of eligible disability assistance expenses:</div>
          <ul>
            <li>
              The payments made on a motorized wheelchair for the 42 year old
              son of the head of household enable the son to leave the house and
              go to work each day on his own. Prior to the purchase of the
              motorized wheelchair, the son was unable to make the commute to
              work. These payments are an eligible disability assistance
              expense.
            </li>
            <li>
              ...
              payments are an eligible disability assistance allowance.
            </li>
          </ul>
          <IntervalColumnHeadings type={type} />
          <CashFlowRow {...sharedProps} generic={"disabledAssistance"}>
            {" "}
          ...
          <CashFlowRowAfterConfirm
            ...
            confirmLabel={
              "Do assistance expenses allow you to make additional income?"
            }
          >
            <span style={{ textDecoration: "underline" }}>Income</span> made
            possible by assistance expenses
          </CashFlowRowAfterConfirm>
        </div>
      ) : null}
       ...
       *     Appendix B, item (D) */}
      {elderlyOrDisabledHeadOrSpouse.length > 0 ||
      (current.hasSnap && elderlyOrDisabled.length > 0) ? (
        <div>
          <FormHeading>Unreimbursed Medical Expenses</FormHeading>
          <div>
            Do not repeat anything you already listed in the section above.
          ...
          <ul>
            ...
            <li>
              Prescription/non-prescription medicines (prescribed by a
              physician).
            </li>
            ...
            <li>
              Monthly payment on accumulated medical bills (regular monthly
              payments on a bill that was previously incurred).
            </li>
          </ul>
          <IntervalColumnHeadings type={type} />
          <CashFlowRow {...sharedProps} generic="disabledMedical">
            {" "}
            Disabled/Elderly medical expenses{" "}
          </CashFlowRow>
          <CashFlowRow {...sharedProps} generic="otherMedical">
            {" "}
