...
const IntervalColumnHeadings = function({ type }) {
  var columnTitle =
      type.toLowerCase().replace(/\b[a-z]/g, letter => letter.toUpperCase()) +
      " Type",
    styles = { fontSize: "14px" };

  return (
    <div style={{ display: "inline-block" }}>
      <ColumnHeading type={type} colName="weekly" style={styles}>
        Weekly
      </ColumnHeading>
      <ColumnHeading type={type} colName="monthly" style={styles}>
        Monthly
      </ColumnHeading>
      <ColumnHeading type={type} colName="yearly" style={styles}>
        Yearly
      </ColumnHeading>
      <ColumnHeading
        type={type}
