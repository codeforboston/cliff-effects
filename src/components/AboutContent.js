...
const AboutContent = function (props) {
  ...
  return (
    <div>
      ...
      <Header
        as='h1'
        style={{ fontSize: '4em' }}>About the Cliff Effects Tool
      </Header>
      ...
      <p>Here's a special thank you to all the Code for Boston volunteers who brought you this application, especially Annie LaCourt, Isaac Chansky, Michelle Bernstein, Alec Danaher, Sasha Maryl, Drew Love, Liani Lye, Andrew Cunningham, Liam Morley, Nick Francisci, Stephen Chin, Shameek Poddar, Will McIntosh, Andrew Seeder, Ben Lewis, Don Blair, Ethan Strominger, Nick Lee, Jonathan Marcus, Emily Wasserman, Ethan Blackwood, and Valerie Kenyon.</p>
