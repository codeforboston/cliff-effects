  ...
  render() {
    ...
    if (message === "default") {
      realMessage =
        'Selecting "' +
        realLeave +
        '" will erase the information you have put into the form. ' +
    ...
    return (
      <Modal open={open}>
        <Modal.Header>
          {header ||
            `Do you want to give feedback before you ${realLeave.toLowerCase()}?`}
        </Modal.Header>
        <Modal.Content>
          <p> {realMessage} </p>
        </Modal.Content>
        <Modal.Actions>
          ...
          <Button onClick={this.props.feedbackPrompt} primary>
            Submit Feedback
          </Button>
        </Modal.Actions>
      </Modal>
