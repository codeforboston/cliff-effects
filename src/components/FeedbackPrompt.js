...
const postUrl =
  "https://script.google.com/macros/s/AKfycbyXYbemTPcqsdbmXITnjaNi-CkN85g5kKPrgzt4AS8ykT2jH6Zn/exec";
        ...
        <Modal.Content scrolling>
          <Form>
            <Form.Input
              ...
              label={
                "If amount for the CURRENT SNAP subsidy was wrong, what's the correct amount?"
              }
            />
            <Form.Input
              {...inputProps("futureSnap")}
              label={
                "If amount for the FUTURE SNAP subsidy was wrong, what's the correct amount?"
              }
            />
            <Form.Input
              {...inputProps("futureS8")}
              label={
                "If amount for the FUTURE Section 8 voucher was wrong, what's the correct amount?"
              }
            />
            <Form.TextArea
              {...inputProps("otherCircumstances")}
              label={
                "What else could be going on that could affect your benefit amount? " +
            ...
            <Form.TextArea
              ...
              label={
                "If there was a bug or error, describe the bug and what you were trying to do when the bug happened."
              }
            />
            <Form.TextArea
              {...inputProps("comments")}
          ...
          <Message hidden={!this.state.submissionFailed} error>
            Error submitting data, please try again or{" "}
            <a href="mailto:andrew@codeforboston.org">email us</a>.
          </Message>
        </Modal.Content>
        <Modal.Actions>
          <Button onClick={this.close} disabled={this.state.submitting}>
            Cancel
          </Button>
          <Button
            onClick={this.submit}
