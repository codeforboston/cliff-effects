 ...
 * const diff = new min ttp - old min ttp;
 * const new rent share = old rent share + diff;
 * const new subsidy = contract rent - new rent share
 *
...
const getSection8Benefit = function (client, timeframe) {
  ...
  const maxShare    = Math.min(contrRent, newShare),
