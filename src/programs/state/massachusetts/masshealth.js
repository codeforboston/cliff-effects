import { percentStateMedianIncome } from '../../../helpers/helperFunctions';

function getMassHealthEligibility(client) {
    let percentSmi = percentStateMedianIncome(parseInt(client.annualIncome, 10), client.householdSize);
